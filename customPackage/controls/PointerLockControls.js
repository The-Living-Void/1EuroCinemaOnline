...
var PointerLockControls = function (camera, cannonBody) {
  ...
  this.update = function (delta) {
    ...
    if (hideHud==true) {
      ...
      js: document.getElementById("map2-4-1").style.left = "-20%";
      js: document.getElementById("map2-4-2").style.left = "-20%";
      js: document.getElementById("map2-4-2").style.left = "-20%";
      js: document.getElementById("map2-4-3").style.left = "-20%";
      js: document.getElementById("map2-4-4").style.left = "-20%";
      js: document.getElementById("map2-4-0").style.left = "-20%";
      js: document.getElementById("map2-3-1").style.left = "-20%";
      js: document.getElementById("map2-3-2").style.left = "-20%";
      js: document.getElementById("map2-3-3").style.left = "-20%";
      js: document.getElementById("map2-3-4").style.left = "-20%";
      js: document.getElementById("map2-3-5").style.left = "-20%";
      ...
      js: document.getElementById("geoevent1").style.right = "-20%";
      js: document.getElementById("geoevent2").style.right = "-20%";
      js: document.getElementById("geoevent3").style.right = "-20%";
      js: document.getElementById("geoevent4").style.right = "-20%";
      ...
      js: document.getElementById("map2-4-1").style.left = "0%";
      js: document.getElementById("map2-4-2").style.left = "0%";
      js: document.getElementById("map2-4-2").style.left = "0%";
      js: document.getElementById("map2-4-3").style.left = "0%";
      js: document.getElementById("map2-4-4").style.left = "0%";
      js: document.getElementById("map2-4-0").style.left = "0%";
      js: document.getElementById("map2-3-1").style.left = "0%";
      js: document.getElementById("map2-3-2").style.left = "0%";
      js: document.getElementById("map2-3-3").style.left = "0%";
      js: document.getElementById("map2-3-4").style.left = "0%";
      js: document.getElementById("map2-3-5").style.left = "0%";
      ...
      js: document.getElementById("geoevent1").style.right = "0%";
      js: document.getElementById("geoevent2").style.right = "0%";
      js: document.getElementById("geoevent3").style.right = "0%";
      js: document.getElementById("geoevent4").style.right = "0%";
